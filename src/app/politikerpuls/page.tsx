...
import PolitikerpulsPageClient from "./PolitikerpulsPageClient";

export default async function PolitikerpulsPage() {
  ...
  return <PolitikerpulsPageClient session={session} />;
}