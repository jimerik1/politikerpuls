...
export default function SettingsContent({ session }: SettingsContentProps) {
  ...
  const secondaryNavigation = [
    { name: 'Konto', href: '#', current: true },
    { name: 'Varsler', href: '#', current: false },
    { name: 'Sikkerhet', href: '#', current: false },
    { name: 'Integrasjoner', href: '#', current: false },
  ];
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="block px-3 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-purple-600 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2">
                  <input
                    ...
                    name="alias"
                    type="text"
                    placeholder={(userName.split(' ')[0] + userName.split(' ').slice(1).join(' ')).toLowerCase()}
                    className="block px-3 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-purple-600 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2">
                  <select
                    id="timezone"
                    name="timezone"
                    className="block px-3 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-purple-600 sm:text-sm sm:leading-6"
                  >
